...
<body>
	...
	<div class="topnav">
  	...
  	<div id="myLinks">
    <a href="others.php">Schedule for others</a>
	...
	<div class="table">
		<table>
			...
			<tbody>
				<?php 
					$sql="SELECT * from maildata where email='$email';";
					...
					{?>
						<tr>
							...
							<td><a href="update.php?id=<?php echo $id;?>&sb=<?php echo $res['subject'];?>&ms=<?php echo $res['message'];?>"><i class="fa fa-edit" aria-hidden="true" style="color:green;"></i></a></td>
							<td><a href="delete.php?id=<?php echo $id;?>"><i class="fa fa-trash" aria-hidden="true" style="color: red;"></i></a></td>
